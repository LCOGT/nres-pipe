...
def ingest(filin):
    ...
    nr.datestrc=strftime("%Y%j.", gmtime()) + str(nr.jdc-int(nr.jdc)) # this is different in input, but will it work?


    nr.expmdata, nr.expmhdr = fits.getdata(filin, "EXPOSURE_METER", header=True)
    nt_expm=nr.expmhdr['NAXIS2']
    jd_start=nr.expmdat['JD_START']
    fib0c=nr.expmdat['FIB0COUNTS']
    fib1c=nr.expmdat['FIB1COUNTS']
    fib2c=nr.expmdat['FIB2COUNTS']
    flg_expm=nr.expmdat['EMFLAGS']
    ...
    nr.agu1data, nr.agu1hdr = fits.getdata(filin, "AGU_1", header=True)
    nt_agu1 = agu1hdr['NAXIS2']
    fname_agu1 = nr.agu1data['FILENAME']
    jd_agu1 = nr.agu1data['JD_UTC']
    nsrc_agu1 = nr.agu1data['N_SRCS']
    skyv_agu1 = nr.agu1['SKYVAL']
    crval1_agu1 = nr.agu1data['CRVAL1']
    crval2_agu1 = nr.agu1data['CRVAL2']
    cd1_1_agu1 = nr.agu1data['CD1_1']
    cd1_2_agu1 = nr.agu1data['CD1_2']
    cd2_1_agu1 = nr.agu1data['CD2_1']
    cd2_2_agu1 = nr.agu1data['CD2_2']
    ...
    nr.agu2data, nr.agu2hdr = fits.getdata(filin, "AGU_2", header=True)
    nt_agu2 = nr.agu2hdr['NAXIS2']
    fname_agu2 = nr.agu2data['FILENAME']
    jd_agu2 = nr.agu2data['JD_UTC']
    nsrc_agu2 = nr.agu2data['N_SRCS']
    skyv_agu2 = nr.agu2data['SKYVAL']
    crval1_agu2 = nr.agu2data['CRVAL1']
    crval2_agu2 = nr.agu2data['CRVAL2']
    cd1_1_agu2 = nr.agu2data['CD1_1']
    cd1_2_agu2 = nr.agu2data['CD1_2']
    cd2_1_agu2 = nr.agu2data['CD2_1']
    cd2_2_agu2 = nr.agu2data['CD2_2']
