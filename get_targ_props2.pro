...
; bail out with null result if targname='NULL' and targra = targdec = 0.
if(targname eq 'NULL' and targra eq 0. and targdec eq 0.) then begin
  targout={targname:'NULL',ra:0.d0,dec:0.d0,vmag:0.0,bmag:0.,gmag:0.,$
         rmag:0.0,imag:0.,jmag:0.,kmag:0.,pmra:0.,pmdec:0.,plax:0.,rv:0.,$
...
; All of this is done in routine get_gaiadat.pro.
  get_gaiadat,targra,targdec,gaiaparms
;gra,gdec,gpmra,gpmdec,gpmra,gpmdec,gplax,$
;      grv,gvmag,gbmag,grmag,ggmag,gteff,glogg,gerr
  if(gaiaparms.gerr eq 0) then begin
    targout={targname:targname,ra:gaiaparms.gra,dec:gaiaparms.gdec,$
      vmag:gaiaparms.gvmag,bmag:gaiaparms.gbmag,gmag:gaiaparms.ggmag,$
      rmag:gaiaparms.grmag,imag:0.,jmag:0.,kmag:0.,pmra:gaiaparms.gpmra,$
      pmdec:gaiaparms.gpmdec,plax:gaiaparms.gplax,$
      rv:gaiaparms.grv,teff:gaiaparms.gteff,logg:gaiaparms.glogg,zero:'NULL'}
  endif else begin
    ierr=1
    targout={targname:'NULL',ra:0.d0,dec:0.d0,vmag:0.0,bmag:0.,gmag:0.,$
           rmag:0.0,imag:0.,jmag:0.,kmag:0.,pmra:0.,pmdec:0.,plax:0.,rv:0.,$
