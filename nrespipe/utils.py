...
def get_calibration_files_taken(raw_directory):
    ...
    dark_files = glob(os.path.join(raw_directory, 'b00.fits.fz'))
    flat_files = glob(os.path.join(raw_directory, 'b00.fits.fz'))
    arc_files = glob(os.path.join(raw_directory, 'b00.fits.fz'))
