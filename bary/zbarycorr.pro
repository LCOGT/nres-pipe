...
;  2014/09 -- Update equations to match accepted version.
;-
...
function zbarycorr, jdutc, ra, dec, pmra=pmra, pmdec=pmdec, px=px, rv=rv, $
                    ...
                    no_nutation=no_nutuation, no_polar_motion=no_polar_motion
...
GM = GMsun/[1d-30,6023600d0,408523.71d0,(X*(Y+1d0))/Y,3098708d0,1047.3486d0,$
