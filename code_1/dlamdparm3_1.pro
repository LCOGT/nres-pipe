pro dlamdparm3_1,site0,lam,gotsp=gotsp
...
; in dlamdcoefs(nx,nord,ncoefs), resp, which reside in thar_comm_1 
...
for i=0,6 do begin
  mxa=1.0
  if(i eq 0) then mxa=1.e4
  if(i eq 3) then mxa=1.e3
  dparmnorm(i)=mxa
