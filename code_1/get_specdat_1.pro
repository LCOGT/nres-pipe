pro get_specdat_1,mjd,err,siter=siter
...
; If keyword siter is set, the site value overrides the site implied in
; environment variable NRESINST, for the purpose of finding the spectrograph.csv
; file.
...
if(keyword_set(siter)) then nresrooti=nresroot+'/RD'+strtrim(siter,2)+'1'
